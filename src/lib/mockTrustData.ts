...
const trustMetrics: TrustMetric[] = [
  ...
  },
  {
    ...
    value: 1,
    subLabel: 'LiDAR audit completed',
    icon: 'third_party',
    weight: 25,
    score: 70,
    sources: [
      {
        name: 'Third-Party LiDAR Validation',
        date: '2025-12-10',
        type: 'third_party',
        snippet: 'Independent LiDAR-based validation completed prior to driverless launch in Austin',
      },
    ],
  },
  {
